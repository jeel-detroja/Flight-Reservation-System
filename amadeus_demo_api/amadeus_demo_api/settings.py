...
# Correct way to define BASE_DIR using pathlib
...
#         'NAME': 'flight_booking',        # Replace with your actual database name
#         'USER': 'root',                  # From "Username" in the image
#         'PASSWORD': '',                  # Leave empty if you didn’t set a password
#         'HOST': '127.0.0.1',             # From "Hostname" in the image
